...
!function (a) {
  ...
  function c(a, b, c, d, e) {
    var f = {type: c.type || c, target: a, result: d};
    S(f, e), b(f)
  }
  ...
  function h(a, b) {
    ...
    } else h(g(a), b); else b("invalid entry")
  }
  ...
  var m = 1, n = function () {
  }, o = a.document, p = o.doctype || {}, q = a.navigator.userAgent, r = a.createObjectURL && a || a.URL && URL.revokeObjectURL && URL || a.webkitURL && webkitURL, s = a.Blob, t = a.File, u = a.FileReader, v = a.FormData, w = a.XMLHttpRequest, x = a.jQuery, y = !(!(t && u && (a.Uint8Array || v || w.prototype.sendAsBinary)) || /safari\//i.test(q) && !/chrome\//i.test(q) && /windows/i.test(q)), z = y && "withCredentials"in new w, A = y && !!s && !!(s.prototype.webkitSlice || s.prototype.mozSlice || s.prototype.slice), B = a.dataURLtoBlob, C = /img/i, D = /canvas/i, E = /img|canvas/i, F = /input/i, G = /^data:[^,]+,/, H = {}.toString, I = a.Math, J = function (b) {
    return b = new a.Number(I.pow(1024, b)), b.from = function (a) {
      return I.round(a * this)
    }, b
  }, K = {}, L = [], M = "abort progress error load loadend", N = "status statusText readyState response responseXML responseText responseBody".split(" "), O = "currentTarget", P = "preventDefault", Q = function (a) {
    return a && "length"in a
  }, R = function (a, b, c) {
    if (a)if (Q(a))for (var d = 0, e = a.length; e > d; d++)d in a && b.call(c, a[d], d, a); else for (var f in a)a.hasOwnProperty(f) && b.call(c, a[f], f, a)
  }, S = function (a) {
    ...
    if (a) {
      ...
      R(b.split(/\s+/), function (b) {
        if (x && !f)x.event.remove(a, b, c); else {
    ...
    ext2mime: {jpg: "image/jpeg", tif: "image/tiff", txt: "text/plain"},
    accept: {
    ...
    getXHR: function () {
      var b;
      if (w)b = new w; else if (a.ActiveXObject)try {
    ...
    readAsImage: function (a, d, e) {
      ...
      }); else if (Y.isCanvas(a))c(a, d, "load", a); else if (C.test(a.nodeName))if (a.complete)c(a, d, "load", a); else {
    ...
    getDropFiles: function (a, b) {
      var c = [], d = k(a), e = Q(d.items) && d.items[0] && g(d.items[0]), i = Y.queue(function () {
        b(c)
      });
    ...
    upload: function (a) {
      ...
      }, a), a.imageAutoOrientation && !a.imageTransform && (a.imageTransform = {rotate: "auto"});
      var b, c = new Y.XHR(a), d = this._getFilesDataArray(a.files), e = this, f = 0, g = 0, h = !1;
      return R(d, function (a) {
        f += a.size
      }), c.files = [], R(d, function (a) {
        c.files.push(a.file)
      }), c.total = f, c.loaded = 0, c.filesLeft = d.length, a.beforeupload(c, a), b = function () {
        var j = d.shift(), k = j && j.file, l = !1, m = i(a);
    ...
    _getFilesDataArray: function (a) {
      ...
      }), b.length || b.push({file: {name: Y.expando}}), b
    },
    _getFormData: function (a, b, c) {
      var d = b.file, e = b.name, f = d.name, g = d.type, h = Y.support.transform && a.imageTransform, i = new Y.Form, j = Y.queue(function () {
        c(i)
      }), k = h && l(h), m = Y.postNameConcat;
      R(a.data, function n(a, b) {
        ...
        b.image ? (j.inc(), b.toData(function (a, b) {
          ...
          if (k && !c)B || Y.flashEngine || (i.multipart = !0), i.append(e, d[0], f, h[0].type || g); else {
            var l = 0;
            c || R(d, function (a, b) {
  ...
  Y.addInfoReader(/^image/, function (a, b) {
    if (!a.__dimensions) {
      ...
      Y.readAsImage(a, function (a) {
        var b = a.target;
        c.resolve("load" == a.type ? !1 : "error", {width: b.width, height: b.height}), b.src = Y.EMPTY_PNG, b = null
      })
    }
  ...
  d.prototype = {
    image: !0, constructor: d, set: function (b) {
      ...
      var f, h = g(), i = this.getMatrix(b), j = h.getContext("2d"), k = b.videoWidth || b.width, l = b.videoHeight || b.height, m = i.deg, n = i.dw, o = i.dh, p = k, q = l, r = i.filter, s = b, t = i.overlay, u = a.queue(function () {
      ...
      h.width = m % 180 ? o : n, h.height = m % 180 ? n : o, h.type = i.type, h.quality = i.quality, j.rotate(m * Math.PI / 180), v(j.canvas, s, i.sx, i.sy, i.sw || s.width, i.sh || s.height, 180 == m || 270 == m ? -n : 0, 90 == m || 180 == m ? -o : 0, n, o), n = h.width, o = h.height, t && a.each([].concat(t), function (b) {
        u.inc();
        var c = new window.Image, d = function () {
          var e = 0 | b.x, f = 0 | b.y, g = b.w || c.width, h = b.h || c.height, i = b.rel;
      ...
      var c = a.extend({}, this.matrix), d = c.sw = c.sw || b.videoWidth || b.naturalWidth || b.width, g = c.sh = c.sh || b.videoHeight || b.naturalHeight || b.height, h = c.dw = c.dw || d, i = c.dh = c.dh || g, j = d / g, k = h / i, l = c.resize;
      if ("preview" == l) {
        if (h != d || i != g) {
          var m, n;
    ...
    function h(h, i) {
      ...
      h ? k.fail() : a.each(e, function (a, e) {
        if (!k.isFail()) {
          ...
          a.rotate === c && f && (a.rotate = "auto"), g.set({type: g.matrix.type || a.type || b.type || "image/png"}), h || g.set({
            deg: a.rotate,
            overlay: a.overlay,
            filter: a.filter,
            quality: a.quality || 1
  ...
  function c(b, c, d) {
    ...
    if (f) {
      ...
      var g = {
        "image/jpeg": ".jpe?g",
        "image/png": ".png"
      }, h = g[b.type] ? b.type : "image/png", i = g[h] || ".png", j = e.quality || 1;
  ...
  var d = b.document, e = b.FormData, f = function () {
    this.items = []
  ...
  "use strict";
  var c = function () {
  }, d = a.document, e = function (a) {
    this.uid = b.uid(), this.xhr = {abort: c, getResponseHeader: c, getAllResponseHeaders: c}, this.options = a
  }, f = {"": 1, XML: 1, Text: 1, Body: 1};
  e.prototype = {
    status: 0, statusText: "", constructor: e, getResponseHeader: function (a) {
      return this.xhr.getResponseHeader(a)
    }, getAllResponseHeaders: function () {
      return this.xhr.getAllResponseHeaders() || {}
    }, end: function (d, e) {
      var f = this, g = f.options;
      ...
      var g, h = this, i = h.uid, j = h.uid + "Load", k = c.url;
        ...
        if (g = h.xhr = b.getXHR(), e.params && (k += (k.indexOf("?") < 0 ? "?" : "&") + e.params.join("&")), g.open("POST", k, !0), b.withCredentials && (g.withCredentials = "true"), c.headers && c.headers["X-Requested-With"] || g.setRequestHeader("X-Requested-With", "XMLHttpRequest"), b.each(c.headers, function (a, b) {
          ...
          g.upload && g.upload.addEventListener("progress", b.throttle(function (a) {
            ...
            if (h.status = g.status, h.statusText = g.statusText, h.readyState = g.readyState, 4 == g.readyState) {
              ...
              } else h.end(g.status); else e.retry = 0, e.end == e.size - 1 ? h.end(g.status) : (b.log("X-Last-Known-Byte: " + a), a && (e.end = a), e.file.FileAPIReadPosition = e.end, setTimeout(function () {
                h._send(c, e)
              }, 0));
              g = null
            }
  ...
  function d(a) {
    var b, c = f.createElement("canvas"), d = !1;
    try {
  ...
  j.prototype = {
    isActive: function () {
      ...
      var b, c, f = this, i = f.video, j = function (d) {
  ...
  var k = function (a) {
    var c = a.nodeName ? b.Image.toCanvas(a) : a, d = b.Image(c);
  ...
  c.support.flash = function () {
    ...
    function o(a, b, e) {
      ...
      var g, j = c.uid(), k = d.createElement("div"), o = 10;
    ...
    function q(a) {
      function b(a) {
        var b, c;
        if (b = c = 0, a.offsetParent)do b += a.offsetLeft, c += a.offsetTop; while (a = a.offsetParent);
        return {left: b, top: c}
      }

      a.getBoundingClientRect(), d.body, (a && a.ownerDocument).documentElement;
      return {top: b(a).top, left: b(a).left, width: a.offsetWidth, height: a.offsetHeight}
    }

    var r = c.uid(), s = 0, t = {}, u = /^https?:/i, v = {
      _fn: {}, init: function () {
        ...
        do if (/js-fileapi-wrapper/.test(a.className))return a; while ((a = a.parentNode) && a !== d.body)
      }, disableMouseover: !1, mouseover: function (a) {
      ...
      }, interval: null, cmd: function (a, b, c, d) {
        ...
        c.flashEngine = !0, j(c, {
          readAsDataURL: function (a, b) {
            ...
            if (k(a))this.parent.apply(this, arguments); else if (a.isShot)b(null, a.info = {
              width: a.width,
              height: a.height
            }); else {
              if (!a.__info) {
          ...
          get: function (a, b) {
            ...
            if (c.log("FlashAPI.Image._apply:", a), k(a))this.parent.apply(this, arguments); else {
              ...
              v.cmd(a, "imageTransform", {
                id: a.id, matrix: d, callback: l(function f(g, h) {
            ...
            var b = this.file, d = b.info, e = this.getMatrix(d);
          ...
          _send: function (a, b) {
            ...
            c.log("FlashAPI.XHR._send: " + d + " -> " + e), i.xhr = {
              headers: {}, abort: function () {
                v.uploadInProgress = !1, v.cmd(d, "abort", {id: e})
      ...
      patchCamera: function () {
        c.Camera.fallback = function (d, e, g) {
          ...
          c.log("FlashAPI.Camera.publish: " + h), f.publish(d, h, c.extend(e, {
            camera: !0, onEvent: a(function i(a) {
