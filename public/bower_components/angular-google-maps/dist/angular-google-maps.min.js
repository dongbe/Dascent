  ...
  (function () {
    ...
    b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmap_sync", [function () {
      ...
      return y = c.promiseTypes, r = c.isInProgress, x = c.promiseStatus, h = c.ExposedPromise, j = c.SniffedPromise, s = function (a, b) {
        ...
        each: p, map: v, managePromiseQueue: u, promiseLock: u, defaultChunkSize: m, chunkSizeFrom: function (a, b) {
        ...
        setEvents: function (c, d, e, f) {
          ...
          return g = a(d, e), null != g ? _.compact(_.map(g.events, function (a, h) {
            ...
            return f && (i = _(f).contains(h)), g.events.hasOwnProperty(h) && b.isFunction(g.events[h]) && !i ? google.maps.event.addListener(c, h, function () {
              ...
              }), d.$evalAsync(a.apply(d, [c, h, e, arguments]))
            }) : void 0
          })) : void 0
    ...
    b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapIsReady", ["$q", "$timeout", function (a, b) {
      ...
      return c = 0, e = [], d = function () {
        ...
        spawn: function () {
          ...
          return c -= 1, e.length = e.length > 0 ? e.length - 1 : 0
        }
      }
    }])
  }.call(this), function () {
    ...
    b.module("uiGmapgoogle-maps.directives.api.utils").factory("uiGmapModelsWatcher", ["uiGmapLogger", "uiGmap_async", "$q", "uiGmapPromise", function (a, b, c, d) {
      return {
        didQueueInitPromise: function (a, c) {
          ...
          var f, g, h, i, j;
          return f = [], h = {}, i = [], j = [], c.models.forEach(function (g) {
            var i;
            return null == g[b] ? a.error(" id missing for model #{m.toString()},\ncan not use do comparison/insertion") : (h[g[b]] = {}, null == d.get(g[b]) ? f.push(g) : (i = d.get(g[b]), e(g, i.clonedModel, c) ? void 0 : j.push({
              model: g,
              child: i
            })))
        ...
        return i = function (d) {
          function i(c, d, g, i, j) {
            ...
            this.scope = c, this.attrs = d, this.map = g, this.defaults = i, this.model = j, this.clean = a(this.clean, this), this.clonedModel = _.clone(this.model, !0), this.isDragging = !1, this.internalEvents = {
              ...
              return function () {
                var c, d;
                if (!a.isDragging)return d = a.convertPathPoints(a.scope.path), null != a.gObject && a.clean(), null != a.scope.model && (c = a.scope), d.length > 0 && (a.gObject = e(a.buildOpts(d, c))), a.gObject ? (a.scope.fit && a.extendMapBounds(a.map, d), f(a.gObject.getPath(), a.scope, "path", function (b) {
                  return a.scope.fit ? a.extendMapBounds(a.map, b) : void 0
    ...
    b.module("uiGmapgoogle-maps.directives.api.models.child").factory("uiGmapMarkerChildModel", ["uiGmapModelKey", "uiGmapGmapUtil", "uiGmapLogger", "uiGmapEventsHelper", "uiGmapPropertyAction", "uiGmapMarkerOptions", "uiGmapIMarker", "uiGmapMarkerManager", "uiGmapPromise", function (b, d, e, f, g, h, i, j, k) {
      var l;
      return l = function (b) {
        ...
        return c(l, b), l.include(d), l.include(f), l.include(h), m = function (a) {
          ...
          var c;
          if (null == a && (a = !0), c = this.getProp("coords", this.scope, this.model), null != c) {
          ...
          if (null == b && (b = !0), !this.isNotValid(a, !1)) {
            if (this.renderGMarker(b, function (b) {
                return function () {
                  var c, d, e;
                  return d = b.getProp("coords", a, b.model), e = b.getProp("icon", a, b.model), c = b.getProp("options", a, b.model), b.opts = b.createOptions(d, e, c), b.isLabel(b.gObject) !== b.isLabel(b.opts) && null != b.gObject && (b.gManager.remove(b.gObject), b.gObject = void 0), null != b.gObject && b.gObject.setOptions(b.setLabelOptions(b.opts)), b.gObject || (b.gObject = b.isLabel(b.opts) ? new MarkerWithLabel(b.setLabelOptions(b.opts)) : new google.maps.Marker(b.opts), _.extend(b.gObject, {model: b.model})), b.externalListeners && b.removeEvents(b.externalListeners), b.internalListeners && b.removeEvents(b.internalListeners), b.externalListeners = b.setEvents(b.gObject, b.scope, b.model, ["dragend"]), b.internalListeners = b.setEvents(b.gObject, {
                    events: b.internalEvents(),
                    $evalAsync: function () {
                    }
                  }, b.model), null != b.id ? b.gObject.key = b.id : void 0
                }
              }(this)), this.gObject && (this.gObject.getMap() || this.gManager.type !== j.type))this.deferred.resolve(this.gObject); else {
    ...
    b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapBasePolysParentModel", ["$timeout", "uiGmapLogger", "uiGmapModelKey", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmap_async", "uiGmapPromise", function (d, e, f, g, h, i, j) {
      ...
      return h = function (d) {
        function g(a, d, f, g, h) {
          ...
          this.attrs = f, this.map = g, this.DEFAULTS = h, this.scope = a, k = null, i = function (a) {
            ...
            return j
          }), i(), this.listeners = this.setEvents(j, a, a, ["radius_changed"]), null != this.listeners && this.listeners.push(google.maps.event.addListener(j, "radius_changed", function () {
            var c, d;
    ...
    b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapLayerParentModel", ["uiGmapBaseObject", "uiGmapLogger", "$timeout", function (d, e) {
      var f;
      return f = function (d) {
    ...
    b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapMarkersParentModel", ["uiGmapIMarkerParentModel", "uiGmapModelsWatcher", "uiGmapPropMap", "uiGmapMarkerChildModel", "uiGmap_async", "uiGmapClustererMarkerManager", "uiGmapMarkerManager", "$timeout", "uiGmapIMarker", "uiGmapPromise", "uiGmapGmapUtil", "uiGmapLogger", function (d, e, f, g, h, i, j, k, l, m, n) {
      ...
      return p = function (a, b) {
        ...
        function k(b, c, d, e) {
          ...
          var g;
          k.__super__.constructor.call(this, b, c, d, e), this["interface"] = l, g = this, p(new f, this), this.scope.pluralsUpdate = {updateCtr: 0}, this.$log.info(this), this.doRebuildAll = null != this.scope.doRebuildAll ? this.scope.doRebuildAll : !1, this.setIdKey(this.scope), this.scope.$watch("doRebuildAll", function (a) {
            return function (b, c) {
    ...
    b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapSearchBoxParentModel", ["uiGmapBaseObject", "uiGmapLogger", "uiGmapEventsHelper", "$timeout", "$http", "$templateCache", function (d, e, f) {
      var g;
      return g = function (d) {
    ...
    b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolygon", ["uiGmapIPolygon", "$timeout", "uiGmaparray-sync", "uiGmapPolygonChildModel", function (b, d, e, f) {
      var g;
      return g = function (d) {
        function e() {
    ...
    b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolygons", ["uiGmapIPolygon", "$timeout", "uiGmaparray-sync", "uiGmapPolygonsParentModel", "uiGmapPlural", function (d, e, f, g, h) {
      var i;
      return i = function (d) {
        function e() {
    ...
    b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolyline", ["uiGmapIPolyline", "$timeout", "uiGmaparray-sync", "uiGmapPolylineChildModel", function (d, e, f, g) {
      var h;
      return h = function (e) {
        function f() {
    ...
    b.module("uiGmapgoogle-maps.directives.api").factory("uiGmapPolylines", ["uiGmapIPolyline", "$timeout", "uiGmaparray-sync", "uiGmapPolylinesParentModel", "uiGmapPlural", function (d, e, f, g, h) {
      var i;
      return i = function (d) {
        function e() {
          this.link = a(this.link, this), e.__super__.constructor.call(this), h.extend(this), this.$log.info(this)
      ...
      return new (i = function () {
        ...
        return i.prototype.require = "ngModel", i.prototype.link = function (a, d, i, j) {
          return c.then(function (c) {
            return function (k) {
              return f.get(a.template, {cache: g}).success(function (f) {
      ...
      return f = "uiGmapStreetViewPanorama", {
        ...
        link: function (g, h) {
          return a.then(function () {
            return function () {
              var a, i, j, k, l, m, n, o, p, q;
              return o = void 0, q = void 0, j = !1, m = void 0, n = null, p = null, a = function () {
                return e.removeEvents(m), null != o && (o.unbind("position"), o.setVisible(!1)), null != q ? (null != (null != q ? q.setVisible : void 0) && q.setVisible(!1), q = void 0) : void 0
              }, l = function (a, c) {
                var d;
                return d = google.maps.geometry.spherical.computeHeading(a, c), j = !0, g.radius = g.radius || 50, p = b.extend({
                  heading: d,
                  zoom: 1,
                  pitch: 0
                }, g.povoptions || {}), n = n = b.extend({
                  navigationControl: !1,
                  addressControl: !1,
                  linksControl: !1,
                  position: a,
                ...
                var b;
                return g.focalcoord ? g.radius ? (a(), null == q && (q = new google.maps.StreetViewService), g.events && (m = e.setEvents(q, g, g)), b = d.getCoords(g.focalcoord), q.getPanoramaByLocation(b, g.radius, function (a, c) {
                  var d, e, f;
                  return null != g.imagestatus && (g.imagestatus = c), null != (null != (f = g.events) ? f.image_status_changed : void 0) && g.events.image_status_changed(q, "image_status_changed", g, c), "OK" === c ? (e = a.location.latLng, l(e, b), d = h[0], o = new google.maps.StreetViewPanorama(d, n)) : void 0
                ...
                return a === b || a === n || j ? void 0 : i()
              }), k = !0, g.$watch("focalcoord", function (a, b) {
                return a === b && !k || null == a ? void 0 : (k = !1, i())
    ...
    return {
      init: _.once(function () {
        ...
        b.prototype = new google.maps.OverlayView, b.prototype.createInfoBoxDiv_ = function () {
          ...
          if (a.isAdded = !0, this.markers_.push(a), c = this.markers_.length, d = this.markerClusterer_.getMaxZoom(), null !== d && this.map_.getZoom() > d)a.getMap() !== this.map_ && a.setMap(this.map_); else if (c < this.minClusterSize_)a.getMap() !== this.map_ && a.setMap(this.map_);
          else if (c === this.minClusterSize_)for (b = 0; c > b; b++)this.markers_[b].setMap(null); else a.setMap(null);
    ...
    (function () {
      a.exports = {Graph: c(2), Heap: c(3), LinkedList: c(4), Map: c(5), Queue: c(6), RedBlackTree: c(7), Trie: c(8)}
    }).call(this)
  }, function (a) {
    (function () {
