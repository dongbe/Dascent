  ...
  c.directive("vcRecaptcha", ["$document", "$timeout", "vcRecaptchaService", function (a, c, d) {
    return {
      ...
      link: function (e, f, g, h) {
        ...
        var j = e.$watch("key", function (a) {
          if (a) {
            40 !== a.length && b();
            var k = function (a) {
              c(function () {
                h && h.$setValidity("recaptcha", !0), e.response = a, e.onSuccess({response: a, widgetId: e.widgetId})
              }), c(function () {
                h && h.$setValidity("recaptcha", !1), e.response = "", e.onExpire({widgetId: e.widgetId})
              }, 12e4)
            };
            d.create(f[0], a, k, {
              ...
              h && h.$setValidity("recaptcha", !1), e.widgetId = a, e.onCreate({widgetId: a}), e.$on("$destroy", i)
            }), j()
          }
        })
      }
